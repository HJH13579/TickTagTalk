...
export const Store = ({ onItemSelected }) => {
    ...
    const handleTouchMove = (e) => {
        ...
        // 예상되는 새로운 위치를 계산
        const newPositionX = storeContainer.current.position.x + diffX * 0.05;

        // newPositionX가 0과 maxX.current 사이에 있을 경우에만 업데이트
        if (newPositionX <= 0 && newPositionX >= -68) {
            storeContainer.current.position.x = newPositionX;
        }
